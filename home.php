...
<div class="container-fluid cont1">
    <div class="row ty">
        <div class="col-sm-12 col-md-6 ccenter">
            <div class="display-4 info_title title1">Bienvenidos a Sinapsis</div>
            
            <div class="display-4 info_title title1"></div>
        </div>
        <div class="col-sm-12 col-md-6 imgrounded ccenter">
            <img src="img/pexels-milad-farhani-8686319.jpg" alt="" class="img-fluid imgperson" width="250">
        </div>
    </div>
</div>
...
<div class="container-fluid">
  <div class="row">
    <div class= "col-sm-12 col-md-6">
      <img src="img/undraw_hooked_re_vl59.svg" alt="" class="Im">
      <p class="parrafo">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed sint voluptas neque deserunt illo nemo enim velit ipsum accusamus natus?</p>
    </div>
    <div class= "col-sm-12 col-md-6">
      <img src="img/undraw_hooked_re_vl59.svg" alt="" class="Im">
      <p class="parrafo">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed sint voluptas neque deserunt illo nemo enim velit ipsum accusamus natus?</p>
